...
import ros_numpy
from yolov5_msgs.msg import Object, Detection
...
def detect():
    ...
    rospy.loginfo("Done")
    rospy.Subscriber("/detection/image_resized", Image, callback)
    pub = rospy.Publisher("/detection/raw", Detection, queue_size=10)
    rospy.spin()
